...
<html lang="en">
  ...
  <head>
    ...
    <title>Glorious Cathedral</title>
      ...
      <div class="bg-faded p-4 my-4">
        <div class="card card-inverse">
          ...
          <div class="card-img-overlay bg-overlay">
            ...
            <h2 class="card-title text-shadow text-white text-uppercase mb-0">OPEN HEAVEN TODAY</h2>
            <h4 class="text-shadow text-white">Topic: It is a New Dawn! (Open Heaven 14 November 2018)</h4>
            <p class="lead card-text text-shadow text-white w-50 d-none d-lg-block">Memorise: “We have also a more sure word of prophecy; whereunto ye do well that ye take heed, as unto a light that shineth in a dark place, until the day dawn, and the day star arise in your hearts:”– 2 Peter 1:19</p>
            <a href="OpenHeaven.php" class="btn btn-secondary">Read More</a>
          </div>
        </div>
      </div>
