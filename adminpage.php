...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="addblog.php">Add Blog Post</a>
            </li>
   ...
   <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">ADD
        ...
        <form method = 'post' action = "formp.php">
          <div class="row">
            ...
            <div class="form-group col-lg-6">
              <label class="text-heading">BLOG TITLE</label>
              <input type="text" class="form-control" name="title">
            </div>
            <div class="form-group col-lg-6">
              <label class="text-heading">BLOG TOPIC</label>
